...
use BABA\Search\Engines\Collabim;
...
if ($argc > 2) {
    ...
    fclose($fp);
    // Lookup for keyword search volume in Ostrava over Google CZ
    $keywords = $engine2->getVolume($keywords,null,[1003782],['search-engine' => 1]);
    ...
    echo "Usage: php kgr-collabim.php <keywords csv file> <out csv file>\n";
}